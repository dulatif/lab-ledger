...
### **🗺️ Modul 1: Spektrum Strategi _Rendering_**

**Tujuan Modul:**

- Menganalisis cara kerja _Client-Side Rendering_ (CSR) dan _trade-off_nya.
...
### **⚙️ Modul 2: _Server-Side Rendering_ (SSR) dengan Next.js**
...
### **🤔 Modul 5: Memilih Strategi _Rendering_ yang Tepat**
...
- **Dokumentasi:**
    - [Next.js Docs - Data Fetching](https://nextjs.org/docs/basic-features/data-fetching/overview)
    - [web.dev - Rendering on the Web](https://web.dev/rendering-on-the-web/)
- **Library:**
    - [`react-window`](https://www.google.com/search?q=%5Bhttps://react-window.vercel.app/%5D\(https://react-window.vercel.app/\))